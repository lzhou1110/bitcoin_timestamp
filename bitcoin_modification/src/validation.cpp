...
bool IsInitialBlockDownload()
{
    ...
    LOCK(cs_main);
//    Always leave initial blockdownload as we always start from new
//    if (latchToFalse.load(std::memory_order_relaxed))
//        return false;
...
{
    printf("DEBUGGING - Entering ContextualCheckBlockHeader \n");
    ...
    printf("DEBUGGING - ContextualCheckBlockHeader - Block timestamp %ld \n", block.GetBlockTime());
    printf("DEBUGGING - ContextualCheckBlockHeader - Adjusted time %ld \n", nAdjustedTime);
    printf("DEBUGGING - ContextualCheckBlockHeader - MAX_FUTURE_BLOCK_TIME %ld \n", MAX_FUTURE_BLOCK_TIME);
...
{
    printf("DEBUGGING - Entering ContextualCheckBlock \n");
...
{
    printf("DEBUGGING - Entering AcceptBlockHeader \n");

    printf("DEBUGGING - AcceptBlockHeader - Checking the system time: %ld \n", GetTime());
    printf("DEBUGGING - AcceptBlockHeader - Checking the time offset: %ld \n", GetTimeOffset());
    printf("DEBUGGING - AcceptBlockHeader - Checking adjusted time: %ld \n", GetAdjustedTime());
    ...
    if (hash != chainparams.GetConsensus().hashGenesisBlock) {
        ...
        printf("DEBUGGING - AcceptBlockHeader - ContextualCheckBlockHeader");
...
{
    printf("DEBUGGING - Entering TestBlockValidity \n");
    AssertLockHeld(cs_main);
